...
```json
{
    ...
    "min_balance": 0,
    "http_server_url": "https://peer-ilp-over-http-endpoint.example/ilp",
    "http_incoming_bearer_token": "http bearer token they will use to authenticate with us",
    "http_incoming_basic_auth_username": "http basic auth username they will use to authenticate with us",
    "http_incoming_basic_auth_password": "http basic auth username they will use to authenticate with us",
    "http_outgoing_bearer_token": "http bearer token we will use to authenticate with them",
    "http_outgoing_basic_auth_username": "http basic auth username we will use to authenticate with them",
    "http_outgoing_basic_auth_password": "http basic auth password we will use to authenticate with them",
    "btp_server_url": "btp+wss://peer-btp-endpoint",
    "btp_outgoing_token": "btp auth token we will use to authenticate with them",
